...
public class Enemy {
    ...
    private static Coordinate startCell;
    private static final Polyomino shape = new Polyomino();
...
//        throw new UnableToCreateEnemyException();
    ...
    private static List<Coordinate> getCellLocationsRelativeToBoardPosition(Coordinate position) {
...
//        }
    ...
    public static int getUndamagedCellCount() {
